...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Volumes/Data/Projects/SafeCheck17/project/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.temp.driver','filesystems.disks.temp.root','filesystems.disks.temp.serve',
'filesystems.disks.temp.throw','filesystems.disks.temp.report','filesystems.links./Volumes/Data/Projects/SafeCheck17/project/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'generated::TIKOcTCjPPCZ3VtG','upload.store','upload.destroy','dashboard','interactive-inspection',
'users.home','users.store','users.update','users.destroy','trucks.home',
'trucks.store','trucks.update','trucks.destroy','certificates.home','certificates.store',
'certificates.update','certificates.destroy','utils.catalog.available-vehicles','utils.catalog.types-of-cert','generated::1wTFqQIoh7z969RA',
'profile.edit','profile.update','profile.destroy','password.edit','password.update',
'appearance','sessions.index','sessions.destroy','form.home','form.store',
'form.delete','form.fields','form.fields.store','form.fields.update','form.fields.delete',
'inspections.home','inspections.digital-inspection','inspections.store','inspections.step-prepare','inspections.save-prepare',
'inspections.step-data','inspections.save-data','inspections.step-questions','inspections.save-questions','inspections.question',
'inspections.step-summary','inspections.save-finish','reports.home','access-control.home','incidences-control.home',
'register','generated::Fxlra4NFA9UnNcO4','login','generated::SY3dwDDR1e7TD7eO','password.request',
'password.email','password.reset','password.store','verification.notice','verification.verify',
'verification.send','password.confirm','generated::9xasSG8cJ7zkPfbc','logout','storage.temp',);
